<template>
  <div class="smartLock">
    <b-modal id="smartLock" title="SmartLock" hide-footer centered>
      <b-row v-if="Object.keys(smartLockAccounts).length > 0" class="mb-3">
        <b-col v-for="(account,i) in Object.keys(smartLockAccounts)" :key="i" md="6" class="mb-2">
          <div class="account-link" @click.prevent="unlockAccount(account)">
      ...
      <b-card no-body class="text-muted">
      ...
      <div class="text-center mt-3">
        <b-button variant="primary" @click.prevent="$bvModal.show('smartLockAddAccount')">
          Add Account
        </b-button>
      </div>
    </b-modal>
    ...
    >
      ...
      <b-button variant="primary" :disabled="username.length < 3 || Object.values(keys)[0].length < 51 || password.length < 5 || cpassword.length < 5" @click.prevent="addAccount">
    ...
    >
      ...
      <div class="text-center">
        ...
        <b-button variant="primary" class="mt-3" @click.prevent="unlockAccount()">
